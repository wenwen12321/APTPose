...
def step(split, opt, actions, dataLoader, model, optimizer=None, epoch=None):
    ...
    for i, data in enumerate(tqdm(dataLoader, 0)):
        ...
        ## Fine-tune stage starting from here!! 
...
## 【Hierarchical masking - all】(adding by 12/6)(modified by 1/26)
#########################################################################################################
def input_augmentation_MAE(input_2D, model_trans, joints_left, joints_right, mask, bone_mask=None, spatial_mask=None, limb_mask1=None, limb_mask2=None):
#########################################################################################################
...
if __name__ == '__main__':
    ...
    if opt.MAE_reload == 1:
        # get the key information of all parameters
