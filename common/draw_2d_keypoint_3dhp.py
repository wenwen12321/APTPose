...
# keypoints = np.load('../../../Dataset/P-STMO_dataset/data_test_3dhp.npz',allow_pickle=True)
# image = mpimg.imread('../3dhp_test/img_000061.jpg')

keypoints = np.load('/home/final/HD/Data/3DHPE/P-STMO_dataset/data_test_3dhp.npz',allow_pickle=True)
image = mpimg.imread('/home/final/HD/Code/ERPoseFormer_v2/3dhp_test/img_000061.jpg')
...
# plt.savefig("../3dhp_test_2d.png", bbox_inches="tight", pad_inches=0.0, dpi=300)
# plt.savefig("/home/final/HD/Data/3DHPE/Visualization/3DHP/3dhp_test_2d.png", bbox_inches="tight", pad_inches=0.0, dpi=300)

save_2d_folder_path = "/home/final/HD/Data/3DHPE/Visualization/3DHP/2D/"
save_2d_file = "3dhp_test_2d.png"
plt.savefig(save_2d_folder_path+save_2d_file, bbox_inches="tight", pad_inches=0.0, dpi=300)
