...
class Model_MAE(nn.Module):
    def __init__(self, args):
        ...
        reproj_layers = args.reproj_layers
        ...
        Reprojection matrix
            ...
            - output: 2D pose (2*17)
        """
        self.reprojection_matrix = FCBlock(3*self.num_joints_in, 2*self.num_joints_out, 2*channel, reproj_layers) #channel_in, channel_out, linear_size, block_num
